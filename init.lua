...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --   builtin.find_files { find_command = { 'fd', '--hidden', '--type', 'file' } }
      -- end, { desc = '[ ] Search files' })
      -- vim.keymap.set('n', '<leader><Left>', builtin.buffers, { desc = '[←] Search buffers' })
      ...
      vim.keymap.set('n', 'z=', builtin.spell_suggest, { desc = 'Select suggested spelling' })
    end,
  },
